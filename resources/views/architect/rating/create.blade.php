...
@section('desc', 'Create a new rating SMS complain.')
        ...
        <div class="card-body">
            <form method="post" action="{{ route('rating.store') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input rows="3" name="informed_to" id="informed_to" placeholder="Informed To" class="form-control @error('informed_to') is-invalid @enderror" value="{{ old('informed_to') }}" />
                        @error('informed_to')
                        <div class="invalid-feedback">
                            <strong>{{ $message }}</strong>
                        </div>
